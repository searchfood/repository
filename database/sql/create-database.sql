...
-- -----------------------------------------------------
-- Table `db_searchfood`.`delivery_status`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_searchfood`.`delivery_status` (
...
-- -----------------------------------------------------
-- Table `db_searchfood`.`kitchen_type`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_searchfood`.`kitchen_type` (
  `id` INT NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`id`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `db_searchfood`.`restaurants` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_restaurants_restaurant_status_idx` (`delivery_status` ASC),
  INDEX `fk_restaurants_kitchen_type1_idx` (`kitchen_type_id` ASC),
  CONSTRAINT `fk_restaurants_restaurant_status`
    FOREIGN KEY (`delivery_status`)
    REFERENCES `db_searchfood`.`delivery_status` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_restaurants_kitchen_type1`
    FOREIGN KEY (`kitchen_type_id`)
    REFERENCES `db_searchfood`.`kitchen_type` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
