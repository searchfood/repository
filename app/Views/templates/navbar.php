<nav class="navbar navbar-expand-lg navbar-dark bg-template">
    <?php if ($route->Path == 'restaurante') { ?>
        ...
        <button class="navbar-toggler hidden-lg-up border-white" type="button" data-toggle="collapse" data-target="#collapsibleNavId" aria-controls="collapsibleNavId" aria-expanded="false" aria-label="Toggle navigation">
