<div class="dropdown" style="padding-top: 17px">
    ...
    <div style="padding-top: 0px;padding-bottom: 0px;position: absolute;" class="dropdown-menu border dropdown-menu-right" aria-labelledby="dropdownMenuButton">
        <div style="color: white;border: none" class="card-header bg-dark">
        ...
        <div style="color: white;border: none" class="card-footer text-center bg-dark">
            <a style="font-size: 15px;color: white;" href="#">Ver todas</a>
        </div>
    </div>
</div>